...
type Method interface {
	...
	SelectTopNIntentByTime(startTime int64, endTime int64, n int) ([]IntentResult, error)
	...
	SelectTopNIntentByDailyRank(startTime int64, endTime int64, n int) ([]IntentResult, error)
